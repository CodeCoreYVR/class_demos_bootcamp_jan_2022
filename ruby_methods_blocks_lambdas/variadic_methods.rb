...
#The reason it is special in ruby, is that if you don’t have a variadic method, 
#it will raise an argument error if not the right number of arguments.  
#In JS they might just say argument is undefined or nul.
