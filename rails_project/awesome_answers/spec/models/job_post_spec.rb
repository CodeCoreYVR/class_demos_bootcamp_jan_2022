...
RSpec.describe JobPost, type: :model do
  ...
  # above is boilerplate as example - we don't need it, so we comment it out
  describe "validates" do
    ...
    describe "title" do
      ...
      it "requires a title to be present" do
        ...
        #.to() accepts an assertion/expectation clase
    ...
    describe "description" do
      ...
      it "requires a description of at least 100 characters" do
        #GIVEN
        # job_post = JobPost.new(description: "abc", title: "khjgjgujfds")
        job_post = FactoryBot.build(:job_post, description: "I am less than 100")
        #WHEN
        job_post.valid?
        #THEN
        expect(job_post.errors.messages).to(have_key(:description))
    ...
    describe "min_salary" do
        it "requires min_salary to be numerical" do
          #GIVEN
          # job_post = JobPost.new(min_salary: "hundred", description: RANDOM_100_CHARS, title: "My min salary title")
          job_post = FactoryBot.build(:job_post, min_salary: "hvjfujgf")
          #WHEN
          job_post.valid?
          #THEN
        ...
        it "requires min_salary to be at least 30_000" do
          #GIVEN
          # job_post = JobPost.new(min_salary: 25_000, description: RANDOM_100_CHARS, title: "My min salary greater than title")
