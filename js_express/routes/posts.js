...
router.get('/', (req, res) => { // -> localhost:3000/posts
    knex('posts')
...
//-----------Create a new Post--------------------------------->
router.post('/', (req, res) => { //localhost:3000/posts
    knex('posts')
    .insert({
...
//----------Show a single Post--------------------------------->
router.get('/:id', (req, res) => { //localhost:3000/posts/:id
    knex('posts')
...
//-----------Delete/Destroy particular Post------------------------->
router.delete('/:id', (req, res) => { //localhost:3000/posts/:id
    knex('posts')
    .where('id', req.params.id)
    .del()
    .then(() => {
