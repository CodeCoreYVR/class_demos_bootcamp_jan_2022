const net = require("net"); // net is a module built into NodeJS is used for creating TCP server
...
const server = net.createServer(function (socket) {
    ...
    socket.on("data", function (data) {
        // data event lister. Whenever the server receives "data" it will trigger this event
